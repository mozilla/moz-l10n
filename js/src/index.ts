...
export interface ParseOptions {
  /**
   * Consider the source to come from an editor,
   * where parsing strictness is relaxed
...
export function parsePattern(
  ...
  switch (format) {
    case 'android':
      return androidParsePattern(src, { editable: options?.editable })
    case 'fluent':
